//criar variáveis player1_name e player2_name pegando seus valores do localStorage
...
function send() {
	//criar variáveis number1 e number2
...
function check()
{
    //criar a variável get_answer obtendo o valor do id "input_check_box"
	get_answer = input_check_box;
